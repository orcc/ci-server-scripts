...
export ECLIPSEURL="http://eclipse.mirror.garr.it/mirrors/eclipse/eclipse/downloads/drops4/R-4.4.2-201502041700/eclipse-platform-4.4.2-linux-gtk$ECLIPSE_ARCH.tar.gz"
