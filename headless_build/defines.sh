...
export ECLIPSEURL="http://eclipse.mirror.garr.it/mirrors/eclipse/eclipse/downloads/drops4/R-4.4.1-201409250400/eclipse-platform-4.4.1-linux-gtk$ECLIPSE_ARCH.tar.gz"
